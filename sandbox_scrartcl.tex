...
%$\;$\\\\
%\noindent \tikzline[4]{7.2}\hspace*{2pt}$\mathbb{CAGLIOSTRO}$\hspace*{2pt}\tikzline[4]{7.2}\\
%
%\begin{center}\noindent{\Huge $\mathfrak{S}$}ilently we fall\\
%through space, the final frontier.\\
%Stars, and stars and stars.\end{center}
%
%$\;$\\\\
%\begin{center}
